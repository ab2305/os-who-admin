"main";/*{"e":{"default":1},"m":{"postcss":["default"],"postcss-value-parser":["default"]},"s":[],"w":null}*/let postcss;_478‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_478‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);
...
_478‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
